...
class HashTable
{
    ...
    struct User {
        string address;
        bool state;
        User(string address_): address(address_), state(true) {}
    };
...
public:
    ...
    bool Add(string &value, const THash1& hash1 = THash1(),const THash2& hash2 = THash2())
    {
    ...
    bool Find(string &value, const THash1& hash1 = THash1(), const THash2& hash2 = THash2())
    {
        int h1 = hash1(value, buffer_size);
        int h2 = hash2(value, buffer_size);
        int i = 0;
